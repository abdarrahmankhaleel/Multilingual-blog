...
@section('body')
    ...
    {{-- {{-- {{dd($setting)}}   الستنق دي عبارة عن ريكورد داتا بيز لما تبعثها كدا از بريمتر للراوت ببعث رقم الايدي ولما تستقبلها في دالة في الكونستركتور لازم تحط التايب بتاعها الي هو المدول الستنق --}}
